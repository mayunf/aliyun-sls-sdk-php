...
use Aliyun\SLS\Models\CreateLogstoreRequest;
use Aliyun\SLS\Models\CreateLogstoreResponse;
use Aliyun\SLS\Models\UpdateLogstoreRequest;
use Aliyun\SLS\Models\UpdateLogstoreResponse;
use Aliyun\SLS\Models\ListLogstoresRequest;
use Aliyun\SLS\Models\ListLogstoresResponse;
use Aliyun\SLS\Models\DeleteLogstoreRequest;
use Aliyun\SLS\Models\DeleteLogstoreResponse;
use Aliyun\SLS\Models\ListTopicsRequest;
use Aliyun\SLS\Models\ListTopicsResponse;
use Aliyun\SLS\Models\GetHistogramsRequest;
use Aliyun\SLS\Models\GetHistogramsResponse;
use Aliyun\SLS\Models\BatchGetLogsRequest;
use Aliyun\SLS\Models\BatchGetLogsResponse;
use Aliyun\SLS\Models\SplitShardRequest;
use Aliyun\SLS\Models\DeleteShardRequest;
use Aliyun\SLS\Models\DeleteShardResponse;
use Aliyun\SLS\Models\MergeShardsRequest;
use Aliyun\SLS\Models\CreateConfigRequest;
use Aliyun\SLS\Models\CreateConfigResponse;
use Aliyun\SLS\Models\UpdateConfigRequest;
use Aliyun\SLS\Models\UpdateConfigResponse;
use Aliyun\SLS\Models\GetConfigRequest;
use Aliyun\SLS\Models\GetConfigResponse;
use Aliyun\SLS\Models\DeleteConfigRequest;
use Aliyun\SLS\Models\DeleteConfigResponse;
use Aliyun\SLS\Models\ListConfigsRequest;
use Aliyun\SLS\Models\ListConfigsResponse;
use Aliyun\SLS\Models\CreateMachineGroupRequest;
use Aliyun\SLS\Models\CreateMachineGroupResponse;
use Aliyun\SLS\Models\UpdateMachineGroupRequest;
use Aliyun\SLS\Models\UpdateMachineGroupResponse;
use Aliyun\SLS\Models\DeleteMachineGroupRequest;
use Aliyun\SLS\Models\DeleteMachineGroupResponse;
use Aliyun\SLS\Models\GetMachineGroupRequest;
use Aliyun\SLS\Models\GetMachineGroupResponse;
use Aliyun\SLS\Models\ListMachineGroupsRequest;
use Aliyun\SLS\Models\ListMachineGroupsResponse;
use Aliyun\SLS\Models\ApplyConfigToMachineGroupRequest;
use Aliyun\SLS\Models\ApplyConfigToMachineGroupResponse;
use Aliyun\SLS\Models\RemoveConfigFromMachineGroupRequest;
use Aliyun\SLS\Models\RemoveConfigFromMachineGroupResponse;
use Aliyun\SLS\Models\GetMachineRequest;
use Aliyun\SLS\Models\GetMachineResponse;
use Aliyun\SLS\Models\CreateACLRequest;
use Aliyun\SLS\Models\CreateACLResponse;
use Aliyun\SLS\Models\UpdateACLResponse;
use Aliyun\SLS\Models\UpdateACLRequest;
use Aliyun\SLS\Models\GetACLResponse;
use Aliyun\SLS\Models\GetACLRequest;
use Aliyun\SLS\Models\DeleteACLResponse;
use Aliyun\SLS\Models\DeleteACLRequest;
use Aliyun\SLS\Models\ListACLsRequest;
use Aliyun\SLS\Models\ListACLsResponse;
...
class Client
{
    ...
    private function send($method, $project, $body, $resource, $params, $headers)
    {
        ...
        $signature = Util::getRequestAuthorization($method, $resource, $this->accessKey, $this->stsToken, $params,
            $headers);
    ...
    public function getCursor(GetCursorRequest $request)
    {
        ...
        if ((empty($mode) xor $fromTime == -1) == false) {
            if (!empty($mode)) {
                throw new Exception ('RequestError',
                    "Request is failed. Mode and fromTime can not be not empty simultaneously");
            } else {
                throw new Exception ('RequestError',
                    "Request is failed. Mode and fromTime can not be empty simultaneously");
            }
        }
